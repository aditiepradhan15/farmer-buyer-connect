...
const translations: Record<Lang, Dict> = {
  ...
  hi: {
    ...
    registerTitle: "अपना पंजीकरण पूरा करें",
    registerHint: "इस फ़ोन नंबर के लिए कोई खाता नहीं मिला। कृपया पंजीकरण के लिए विवरण भरें।",
    yourName: "आपका नाम",
    villageLabel: "गाँव",
    businessType: "व्यवसाय का प्रकार",
    businessHousehold: "घरेलू",
    businessRestaurant: "रेस्तराँ",
    businessHotel: "होटल",
    businessSupermarket: "सुपरमार्केट",
  ...
  mr: {
    ...
    registerTitle: "तुमची नोंदणी पूर्ण करा",
    registerHint: "या फोन नंबरसाठी खाते सापडले नाही. कृपया नोंदणीसाठी तपशील भरा.",
    yourName: "तुमचे नाव",
    villageLabel: "गाव",
    businessType: "व्यवसायाचा प्रकार",
    businessHousehold: "घरगुती",
    businessRestaurant: "रेस्टॉरंट",
    businessHotel: "हॉटेल",
    businessSupermarket: "सुपरमार्केट",
    vehicleType: "वाहनाचा प्रकार",
    vehicleReg: "वाहन नोंदणी क्रमांक",
